...
local plugin_specs = {
  ...
  {
    "fatih/vim-go",
    build = ":GoUpdateBinaries", -- Installiert benötigte Go-Binaries
    ft = { "go" }, -- Lädt das Plugin nur für Go-Dateien
    config = function()
      vim.g.go_fmt_command = "gofmt" -- Verwende gofmt für die Formatierung
      vim.g.go_auto_type_info = 1 -- Automatische Typinformationen
      vim.g.go_auto_sameids = 1 -- Markiere identische Variablen
    end,
  },
}
